...
function ListPlay(props) {
    ...
    const notDetail = (e) => {
        ...
        else if (e.target.id === 'play' || e.target.id === 'plus' || e.target.id === 'up' || e.target.id === 'down' || e.target.id === 'time' || e.target.id === 'chevron' || e.target.id === 'watch_time' || e.target.id === 'watch_text') {
